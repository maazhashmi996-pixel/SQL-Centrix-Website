            ...
            >
              ...
              <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-500">
                ...
                <span className="text-yellow-400">
                  {" "}
                  right strategy and share insights relevant to your
                  objectives.
                </span>
              </p>
            </motion.div>
              ...
              <form onSubmit={handleSubmit} className="space-y-7">
                ...
                <div className="space-y-4 border-t border-slate-100 pt-6">
                  <label className="flex cursor-pointer items-start gap-3">
                    ...
                    <span className="text-xs leading-5 text-black">
                      ...
                      <span className="text-yellow-400">
                        provided to respond to your enquiry and deliver the
                        services or information you requested.
                      </span>
                    </span>
                  </label>
                ...
                <div className="rounded-2xl border border-slate-100 bg-slate-50/70 p-5">
                  <p className="text-xs leading-5 text-black">
                    ...
                    <span className="text-yellow-400">
                      Please review our Privacy Policy to learn how we collect,
                      use, and safeguard your personal information. You can
                  ...
                  <p className="mt-3 text-xs leading-5 text-black">
                    ...
                    and processing your information for{" "}
                    <span className="text-yellow-400">
                      the purpose of contacting you regarding your enquiry and
