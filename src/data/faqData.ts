...
export const faqList: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "A Sales Qualified Lead (SQL) is a prospective client who has been vetted, meets your specific ideal customer profile (ICP), and exhibits clear intent to buy. We build integrated digital growth systems combining brand positioning, high-converting websites, paid media, and SEO.",
  },
  {
    question: "How does SQL Centrix differ from traditional digital marketing agencies?",
    answer: "Most marketing agencies sell isolated services (like social media management). We invest in business outcomes. Our process starts at the end goal: revenue generation and complete ecosystem execution.",
  },
  {
    question: "What is AI Search Optimization, and why is it important for lead generation?",
    answer: "AI Search Optimization (LLMO/GEO) ensures your brand is indexed, cited, and recommended by AI engines (like ChatGPT, Gemini, and Perplexity) as well as traditional search engines like Google.",
  },
  {
    question: "Can SQL Centrix collaborate with our in-house marketing team?",
    answer: "Yes. We regularly operate alongside internal marketing teams as an extended performance arm or handling specific channels like search visibility, digital PR, or advertising.",
  },
  {
    question: "How long does it take to see results from an SQL Centrix growth system?",
    answer: "Paid media can generate qualified inbound enquiries within days, while organic strategies like SEO, authority building, and content marketing compound over 3 to 6 months to establish market dominance.",
  },
  {
