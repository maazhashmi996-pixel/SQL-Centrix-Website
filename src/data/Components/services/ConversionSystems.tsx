...
const services = [
  ...
  },
  {
    title: "Landing Pages",
    icon: MousePointer2,
    subheading: "Give Every Campaign A Clear Destination",
    description:
  ...
  },
  {
    ...
    subheading: "Give Customers The Information They Need To Decide",
    description:
  ...
  },
  {
    title: "UX & UI",
    icon: Zap,
    subheading: "Remove Friction From The Buying Journey",
    description:
  ...
  },
  {
    title: "Trust & Proof",
    icon: ShieldCheck,
    subheading: "Give Prospects A Reason To Believe You",
    description:
  ...
  },
  {
    ...
    icon: BarChart3,
    subheading: "Improve The Performance Of What You Already Have",
    description:
      ...
      <section className="relative px-6 py-20 lg:py-32">
        ...
        <div className="relative mx-auto max-w-[1180px] text-center">
          ...
          >
            ...
            >
              Getting the right people to your business doesn't guarantee they
          ...
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
            ...
            >
              ...
              <p className="mt-6 leading-relaxed text-slate-600">
                We structure the digital experience around those questions so
                prospects can move from interest to action with less uncertainty
                and friction.
              </p>
            </motion.div>
                  ...
                  <React.Fragment key={item}>
                    ...
                    {index < 7 && (
                      <motion.div
                        ...
                        className="text-center font-bold text-yellow-300"
                      >
                        ↓
                      </motion.div>
                    )}
                ...
                >
                  <div className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr]">
                    ...
                    <div>
                      ...
                      {/* ADDED CONTENT ONLY */}
                      <p className="mt-5 text-lg font-bold leading-relaxed text-slate-900">
                        {service.subheading}
                      </p>
        ...
        <div className="mx-auto max-w-[1000px]">
          ...
          >
            ...
            <div className="mx-auto mt-7 max-w-2xl space-y-2 text-sm font-semibold text-slate-600">
              ...
              <p>
                Getting that traffic to take action is a conversion problem.
              </p>
            </div>
          </motion.div>
        </div>
      ...
      >
        ...
        >
          ...
          >
            <a
              href="#contact"
              className="relative inline-flex items-center gap-3 overflow-hidden rounded-xl border border-yellow-400 bg-white px-8 py-4 text-xs font-extrabold uppercase tracking-wider text-slate-950 shadow-[0_12px_30px_rgba(234,179,8,0.18)] transition-all duration-300 hover:bg-yellow-400 hover:shadow-[0_18px_45px_rgba(234,179,8,0.32)]"
            >
