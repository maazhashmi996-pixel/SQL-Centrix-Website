            ...
            <AnimatePresence>
              {servicesDropdownOpen && (
                <motion.div
                  ...
                  className="absolute left-1/2 top-full mt-2 w-[340px] -translate-x-1/2 rounded-2xl border border-slate-100 bg-white p-2 shadow-[0_20px_40px_rgba(15,23,42,0.08)]"
                >
                    ...
                    {servicesList.map((service) => (
                      <li key={service.name}>
                        <a
                          ...
                          className="group flex flex-col rounded-xl px-3.5 py-2.5 transition-all hover:bg-yellow-50/70"
                        >
                          <span className="flex items-center justify-between text-xs font-bold text-slate-800 transition-colors group-hover:text-slate-950">
                            {service.name}
                            <ChevronRight className="h-3 w-3 text-yellow-500 opacity-0 transition-all group-hover:opacity-100 group-hover:translate-x-0.5" />
                          </span>
                          <span className="mt-0.5 text-[11px] text-slate-500 leading-normal">
                            {service.desc}
                          </span>
                        </a>
                      </li>
