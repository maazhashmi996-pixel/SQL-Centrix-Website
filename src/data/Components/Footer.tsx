...
export default function Footer() {
  ...
  return (
    <footer 
      ref={containerRef}
      id="contact" 
      className="relative pt-19 pb-20 px-6 lg:px-20 bg-gradient-to-b from-white via-slate-50/80 to-amber-50/30 overflow-hidden text-slate-900 border-t border-amber-100/80 selection:bg-amber-500 selection:text-slate-950"
    >
      ...
      <div className="absolute bottom-20 right-0 w-[550px] h-[550px] bg-gradient-to-br from-yellow-200/50 via-amber-100/40 to-transparent blur-[180px] rounded-full pointer-events-none" />
      <div className="absolute top-1/4 -left-20 w-[500px] h-[500px] bg-gradient-to-tr from-amber-200/60 via-yellow-100/30 to-transparent blur-[160px] rounded-full pointer-events-none" />
          ...
          >
            <div className="space-y-4">
              ...
              <h2 className="text-3xl sm:text-5xl font-black text-slate-900 tracking-tight leading-[1.12]">
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-600 via-yellow-600 to-amber-700 font-serif italic font-normal tracking-normal">
                  growth goals.
                </span>
              </h2>
            ...
            <div className="space-y-4">
              {[
                ...
                return (
                  ...
                  >
                    <div className="w-12 h-12 rounded-2xl bg-amber-50 border border-amber-200/80 text-amber-700 flex items-center justify-center flex-shrink-0 group-hover:bg-amber-500 group-hover:text-slate-950 group-hover:border-amber-500 group-hover:rotate-6 transition-all duration-500 shadow-sm">
          ...
          >
            ...
            >
              ...
              <motion.div 
                ...
                className="absolute top-0 left-0 right-0 h-[4px] bg-[length:200%_auto] bg-gradient-to-r from-amber-500 via-yellow-400 to-amber-600"
              />
              ...
              <motion.button 
                ...
                whileTap={{ scale: 0.98 }}
                type="submit" 
                className="w-full bg-gradient-to-r from-amber-500 via-yellow-400 to-amber-600 hover:from-amber-600 hover:to-yellow-500 text-slate-950 font-bold py-4.5 px-6 rounded-2xl transition duration-300 text-sm shadow-xl shadow-amber-500/20 flex items-center justify-center gap-3 group cursor-pointer relative overflow-hidden border border-amber-300"
              >
                <motion.div 
                  animate={{ x: ["-100%", "200%"] }}
