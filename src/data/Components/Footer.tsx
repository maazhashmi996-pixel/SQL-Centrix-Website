...
export default function Footer() {
  ...
  return (
    <footer 
      ref={containerRef}
      id="contact" 
      className="relative pt-19 pb-20 px-6 lg:px-20 bg-white overflow-hidden text-slate-900 border-t border-amber-100/80 selection:bg-amber-500 selection:text-white"
    >
      
      {/* Absolute Luxurious Light Ambient Backdrops matching the Yellow/Amber Gradient Theme */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[700px] bg-[radial-gradient(ellipse_80%_60%_at_50%_-10%,rgba(245,158,11,0.15),rgba(255,255,255,0))] pointer-events-none" />
      <div className="absolute bottom-20 right-0 w-[550px] h-[550px] bg-gradient-to-br from-amber-200/50 via-yellow-100/40 to-transparent blur-[180px] rounded-full pointer-events-none" />
      <div className="absolute top-1/4 -left-20 w-[500px] h-[500px] bg-gradient-to-tr from-orange-200/60 via-amber-100/30 to-transparent blur-[160px] rounded-full pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center pb-20 border-b border-amber-100/80">
          ...
          >
            <div className="space-y-4">
              ...
              <h2 className="text-3xl sm:text-5xl font-black text-slate-900 tracking-tight leading-[1.12]">
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-600 via-yellow-600 to-orange-600 font-serif italic font-normal tracking-normal">
                  growth goals.
                </span>
              </h2>
              ...
              {[
                ...
                return (
                  <motion.div 
                    ...
                    whileTap={{ scale: 0.98 }}
                    className={`flex ${item.isAddress ? 'items-start' : 'items-center'} gap-4.5 p-5 rounded-2xl bg-white/90 border border-amber-200/80 cursor-pointer group shadow-[0_10px_30px_rgba(245,158,11,0.04)] hover:shadow-[0_20px_40px_rgba(245,158,11,0.1)] transition-all duration-300 backdrop-blur-xl`}
                  >
                    <div className="w-12 h-12 rounded-2xl bg-amber-50 border border-amber-200/80 text-amber-700 flex items-center justify-center flex-shrink-0 group-hover:bg-gradient-to-r group-hover:from-amber-600 group-hover:to-yellow-600 group-hover:text-white group-hover:border-amber-500 group-hover:rotate-6 transition-all duration-500 shadow-sm">
          ...
          >
            <form 
              ...
              className="bg-white/95 backdrop-blur-2xl p-8 sm:p-12 rounded-[2.5rem] border border-amber-200 shadow-[0_30px_70px_-15px_rgba(245,158,11,0.12)] space-y-6 relative overflow-hidden"
            >
              ...
              <motion.div 
                ...
                className="absolute top-0 left-0 right-0 h-[4px] bg-[length:200%_auto] bg-gradient-to-r from-amber-600 via-yellow-600 to-orange-600"
              />
              ...
              {isSubmitted && (
                <motion.div 
                  ...
                  className="p-4 rounded-2xl bg-amber-50 border border-amber-200 text-amber-900 text-sm font-semibold flex items-center gap-3 shadow-sm"
                >
                  <CheckCircle2 className="w-5 h-5 text-amber-600 flex-shrink-0 animate-bounce" />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div className="space-y-1.5">
                  ...
                  <input 
                    type="text" 
                    placeholder="John" 
                    className="w-full bg-slate-50/80 border border-slate-200/80 rounded-2xl p-4 text-slate-900 text-sm placeholder:text-slate-400 focus:outline-none focus:border-amber-600 focus:bg-white focus:ring-4 focus:ring-amber-600/10 transition-all shadow-sm font-medium" 
                    required 
                  />
                </div>
                <div className="space-y-1.5">
              ...
              <div className="space-y-1.5">
                ...
                <textarea 
                  ...
                  className="w-full bg-slate-50/80 border border-slate-200/80 rounded-2xl p-4 text-slate-900 text-sm placeholder:text-slate-400 focus:outline-none focus:border-amber-600 focus:bg-white focus:ring-4 focus:ring-amber-600/10 transition-all shadow-sm resize-none font-medium" 
                ></textarea>
              </div>

              <motion.button 
                whileHover={{ scale: 1.02, boxShadow: "0 28px 50px -12px rgba(245, 158, 11, 0.35)" }}
                whileTap={{ scale: 0.98 }}
                type="submit" 
                className="w-full bg-gradient-to-r from-amber-600 via-yellow-600 to-orange-600 hover:from-amber-700 hover:to-yellow-700 text-white font-bold py-4.5 px-6 rounded-2xl transition duration-300 text-sm shadow-xl shadow-amber-600/20 flex items-center justify-center gap-3 group cursor-pointer relative overflow-hidden border border-amber-400/40"
              >
                <motion.div 
                  animate={{ x: ["-100%", "200%"] }}
